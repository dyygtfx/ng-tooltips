;(function widthAngular(anuglar) {
    'use strict';
    angular.module('ngTooltips',[])
        .provider('tooltipsConfig',function TooltipsConfig() {
            var options = {
                'scroll': false,
            ...
            return {
                ...
                'link': function linkingFunction($scope,element,attr) {
                    var initialized = false,
                        thisElement = angualr.element(element[0]),
                        ...
                        tooltipScroll = attr.tooltipScroll || tooltipConfig.scroll,
                        content = attr.tooltipContent || '',
                        html = attr.tooltipHtml || '',
                        showTriggers = attr.tooltipShowTrigger || tooltipsConfig.showTrigger,
                        hideTriggers = attr.tooltipHideTarget || tooltipsConfig.hideTrigger,
                        ...
                        lazyMode = typeof attr.tooltipLazy !== 'undefined' && attr.tooltipLay !== null ? $scope.$eval(attr.tooltipLazy) : tooltipsConfig.closeButton,
                        hasCloseButton = typeof closeButtonContent !== 'undefined' && closeButtonContent !== null,
                        htmlTemplate = '<div class="_ng-tooltip '+CSS_PREFIX + size+'">';
                    ...
                    $scope.isTooltipEmpty = function checkEmptyTooltip() {
                        if (!scope.title && !attr.tooltipView) {
                            return true;
                        }
                    };
                    ...
                    $scope.getOffsetLeft = function getOffsetLeft(elem) {
                        var offleft = elem.getBoundingClientRect().left + $window.pageXOffset;
                        if (isNaN(offleft)) {
                    ...
                    $scope.bindShowTriggers = function bindShowTriggerHandle() {
                        thisElement.bind(showTriggers,onMouseEnterAndMoonMouseEnterAndMouseOver);
